            ...
            {[
              {
                ...
                desc: "기존에 운영 중인 자사 CSMS나 ERP 시스템에 CSAutobot의 검색 및 조치 가이드 엔진을 그대로 이식할 수 있습니다.",
                tag: "시스템 통합",
                accent: "#06b6d4",
              },
              {
                ...
                desc: "특정 모델 및 펌웨어별 빈발 장애, 부품 불량률을 추적하는 제조사 전용 통계 대시보드를 제공합니다.",
                tag: "품질 관리",
                accent: "#f59e0b",
              },
              {
                ...
                icon: "🚍",
                title: "가동률 중심 예지 정비",
                desc: "단순 사후 대응을 넘어, 설비 센서 데이터를 연동하여 고장 발생 전 이상 징후를 선제적으로 알람합니다.",
                tag: "다운타임 제로",
                accent: "#10b981",
              },
            ].map((mod, idx) => (
      ...
      >
        <div style={{ maxWidth: "760px", margin: "0 auto" }}>
          ...
          >
            ...
            >
              {[
                { label: "회사명", placeholder: "예) (주)충전운영사" },
                { label: "담당자명", placeholder: "예) 홍길동" },
                { label: "이메일", placeholder: "예) contact@company.com" },
                { label: "연락처", placeholder: "예) 010-0000-0000" },
              ].map((field) => (
                <div
                  key={field.label}
                  style={{
            ...
            <a
              href="mailto:contact@csautobot.com?subject=CSAutobot 도입 상담 문의"
              style={{
                display: "block",
                width: "100%",
